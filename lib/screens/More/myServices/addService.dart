...
class _AddService extends State<AddService> {
  ...
  Future<void> addService(title, duration, price, description) async {
    ...
    var url = Uri.parse(
        'https://carwash-back.herokuapp.com/company/company/v1/services');
    ...
    if (response.statusCode == 200) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text("Error Adding Service..."),
